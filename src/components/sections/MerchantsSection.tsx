      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center max-w-[1200px] mx-auto px-6">
        ...
        <div className="flex flex-col items-start">
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
            <a href={`${import.meta.env.VITE_FRONTEND_URL ?? 'http://localhost:3000'}/comerciante/login`} className="bg-[#FACC15] hover:bg-[#EAB308] text-[#111827] font-semibold px-8 py-4 rounded-full shadow-[0_4px_20px_rgba(250,204,21,0.40)] hover:-translate-y-0.5 transition-all text-center">
              Ativar meu negócio
            </a>
