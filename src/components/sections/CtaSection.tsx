      ...
      <div className="max-w-[1200px] mx-auto px-6">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            ...
            <a href={`${import.meta.env.VITE_FRONTEND_URL ?? 'https://painel.zappicidadebarcarena.com.br'}/comerciante/login`} className="bg-[#FACC15] hover:bg-[#EAB308] text-[#111827] font-semibold px-8 py-4 rounded-full flex items-center justify-center gap-2 hover:-translate-y-0.5 transition-all">
